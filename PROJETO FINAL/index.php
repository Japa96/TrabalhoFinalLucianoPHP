        ...
        <div class="bg-success">            
            <div id="menu-nav-bar">       
                <div id="bg-menu">
                    ...
                    <div id="login-side">                         
                         <form action="infrastructure/Controllers/validate-login.php" method="post">
                         <?php
                            session_start();
                            if((isset($_SESSION['email'])) and (isset($_SESSION['senha']))){
                                ...
                                ";
                                echo "<div id='logout-button'><a class='btn btn-default' href='infrastructure/Controllers/destroy-session.php'>Sair</a></div>";
                            }
                            else{
                                include 'infrastructure/Modify-Interface/login-effect.php';
                                LoadFormToLogin();
                            }
                         ?>
                        </form>
