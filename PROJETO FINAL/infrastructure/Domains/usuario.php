        ...
        <div class="bg-success">
            <div id="menu-nav-bar"> 
                ...
                <div id="bg-menu">
                    ...
                    if($value==1){
                        echo "<a class='btn btn-default' href='usuario.php' role='button'>Usuario</a>";
                    }
                    ?>
	            ...
	            <div class="bg-success">
	            	<div id="second-menu">
	            		...
	            		<a class='btn btn-default' href='../Controllers/usuario-controller/registra_usuario.php' role='button'>Registrar novo usuario</a>
	            		<a class='btn btn-default' href='../Controllers/usuario-controller/Actions/action-lista.php' role='button'>Listar Usuarios</a>
	            	</div>
	            </div>
            </div>
        </div>
